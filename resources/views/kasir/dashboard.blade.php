            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-medium text-gray-500">Menunggu Konfirmasi</h3>
                        <p class="mt-1 text-3xl font-semibold text-gray-700">
                            {{ $pendingConfirmation ?? 0 }} Orang
                        </p>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-medium text-gray-500">Menunggu Pembayaran</h3>
                        <p class="mt-1 text-3xl font-semibold text-gray-700">
                            {{ $waitingForPayment ?? 0 }} Orang
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium mb-4">
                        ...
                        ({{ \Carbon\Carbon::today()->isoFormat('D MMMM Y') }})
                    </h3>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left font-medium text-gray-500 uppercase">Antrian</th>
                                    <th class="px-6 py-3 text-left font-medium text-gray-500 uppercase">Nama Pasien</th>
                                    <th class="px-6 py-3 text-left font-medium text-gray-500 uppercase">Dokter</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @elseif ($booking->status == 'completed' && !$booking->payment)
                                                <a href="{{ route('kasir.payment.create', $booking->id) }}" 
                                                   class="px-4 py-2 bg-green-600 text-white rounded-md text-xs hover:bg-green-700">
                                                    Proses Pembayaran
                                                </a>
                                            @elseif ($booking->payment)
                                                <a href="{{ route('kasir.payment.show', $booking->payment->id) }}" 
                                                   target="_blank" 
                                                   class="px-4 py-2 bg-gray-600 text-white rounded-md text-xs hover:bg-gray-700">
                                                    Cetak Kwitansi
                                                </a>
                                            @else
